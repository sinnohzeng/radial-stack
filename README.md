...
- **响应式布局** — 桌面 / 平板 / 手机三档自适应，移动端悬浮下载按钮（FAB）
...
- 加载自定义字体，开启文字轮廓化导出
- 切换深色/浅色主题，切换界面语言
- 一键下载 SVG、PNG 或 JPG（移动端通过底部悬浮按钮下载）
...
├── export.js          # SVG/PNG/JPG 导出（含自适应 JPEG 压缩）
